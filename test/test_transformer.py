...
class TransformerTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        if len(cls.web3.geth.personal.list_accounts()) < 2:
            ...
            tx_hash = cls.transformer_controller.user_contract.functions.createUser(2).transact()
    ...
    def test_a_create_products(self):
        ...
        self.assertTrue(self.transformer_controller.create_new_product_on_blockchain("Prodotto3 Test", [3, 5]))
    ...
    def test_c_transfer_product(self):
        ...
        self.assertTrue(self.transformer_controller.transfer_product_on_blockchain(self.transformer, 2))
    ...
    def test_i_add_transformation_failed_is_not_owner(self, mock_stdout):
        ...
        self.assertFalse((self.transformer_controller.add_transformation_on_blockchain(50, 3, False)))
        self.assertEqual(mock_stdout.getvalue(),
                         "execution reverted: To add a carbon footprint to a product you must be its owner. Operation failed.\n")
        self.assertNotEqual(self.product_3.cf, self.transformer_controller.get_product(3).cf)

    @unittest.mock.patch('sys.stdout', new_callable=io.StringIO)
    def test_l_create_product_failed_not_rm_owner(self, mock_stdout):
        self.assertFalse(self.transformer_controller.create_new_product_on_blockchain("Prodotto Misuse", [1, 7]))
        self.assertEqual(mock_stdout.getvalue(),
