...
from off_chain.filters import (
    simple_filter,
    and_filter,
    or_filter,
    personalized_contains,
)
...
def get_products():
    return [
        Product("Prodotto1", "0x0fbdc686b912d7722dc86510934589e0aaf3b55a", 45, True, 1),
...
def get_events():
    return [
        {
            "args": {
                "transformer": "0x30Fd3731FE1Deee29f9325c19e22C2A71099240b",
                "supplier": "0x788809a43373249aAC1938A19F66218cf590A5c6",
                "pId": 1,
                "name": "MateriaPrima",
                "lot": 0,
                "cf": 10,
            ...
            "transactionHash": HexBytes(
                "0xc223b643654a45e196b51a3461b07fbdd650eb96bab640d9caa71c3b1d563ae3"
            ),
            "address": "0x6a55e9Af01d3741079C1b855857933F5e2fa3D5a",
            "blockHash": HexBytes(
                "0x1349ca0c238612f43ccd8692763206a5853ee6c8816c2ce2d4dc4969ef398a58"
            ),
            "blockNumber": 132,
        },
        {
            "args": {
                "transformer": "0x0fbdc686b912d7722dc86510934589e0aaf3b55a",
                "supplier": "0xca843569e3427144cead5e4d5999a3d0ccf92b8e",
                "pId": 1,
                "name": "RawMaterial",
                "lot": 2,
                "cf": 15,
...
class FilterTest(unittest.TestCase):
    ...
    def test_supplier_filter(self):
        criteria = {
            "elements": get_events,
            "value": "0xca843569e3427144cead5e4d5999a3d0ccf92b8e",
            "field": "supplier",
            "operator": operator.eq,
            "event": True,
        }
    ...
    def test_transformer_filter(self):
        criteria = {
            "elements": get_events,
            "value": "0x30Fd3731FE1Deee29f9325c19e22C2A71099240b",
            "field": "transformer",
            "operator": operator.eq,
            "event": True,
        }
